...
export default async function getUsersLifeTimeTop50Tracks (): Promise<Track[]> {
  // get a list of the users top 50 tracks
  const response = await api.get('/v1/me/top/tracks?time_range=long_term&limit=50&offset=0')
